...
import { categoryFetchApi, UserSideCategoryFetchApi } from "../../redux/admin/AdminThunk";
...
export default function UserCategoryAdd() {
  ...
  const formhandeler = async (e) => {
    ...
    try {
      dispatch(UserSideCategoryFetchApi({ formdata, toast, setFormdata }));
    } catch (error) {

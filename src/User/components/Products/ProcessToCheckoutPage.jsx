...
export default function ProcessToCheckoutPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Response from fjetchPlaceOrderApi: ", response);
                ...
                <div className="col-sm-5">
                  <div className="card p-4">
                    ...
                    <div className="flex justify-between text-center">
                      {/* Store Pickup Option */}
                      <div
                        className={`relative w-[45%] h-[170px] p-[15px] gap-[20px] shippinCheckout border-2 cursor-pointer ${
                          selectedOption === "free"
                      ...
                      <div
                        className={`relative w-[45%] h-[170px] p-[15px]  border-2 cursor-pointer ${

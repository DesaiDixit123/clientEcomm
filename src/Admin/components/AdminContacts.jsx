...
//   const handeleDeleteContact = async (contactId) => {
...
//     setSortBy(selectedSort); // Update sort state
//   };
...
//                               color="error"
//                               className="error"
//                               onClick={() => handeleDeleteContact(contact._id)}
//                             >
//                               <MdDelete />
//                             </Button>
//                           </div>
...
//               <p>
//                 Showing <b>{getAllContacts.length}</b> of{" "}
//                 <b>{getAllContacts.length}</b> results
//               </p>
//               <Pagination
//                 count={Math.ceil(getAllContacts.length / contactsPerPage)}
//                 page={currentPage}
